...
class Konto:
  ...
  def konto_informationen_anzeigen(self,kontonr):
    '''Informationen zu Konto anzeigen'''
...
class Transaktionen(Konto):
  ...
  def konto_einzahlen(self):
      ...
      print()
      kontonr = input("Auf welches Konto wollen Sie einzahlen (Bitte Kontonummer angeben): ")
  ...
  def konto_transaktionen_anzeigen(self):
      ...
      while True:
        ...
        if kontonr == "0":
            ...
            print("{0:>4}{1:^25}{2:>10}".format( "ID", "Datum", "Betrag", "Kontostand"))
