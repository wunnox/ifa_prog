...
while ende!='e':
   ...
   wg=int(input("Anzahl Wegli       : "))                    #Anzahl Wegli abfragen
   zo=int(input("Anzahl Buterzopf   : "))                    #Anzahl Butterzopf abfragen

   rechnung=(gi*gipfeli)+(nussgipfel*ng)+(zimtschnecke*zs)+(wegli*wg)+(zopf*zo)   #Berechnung Preis
